//Redigeret kopi af Scan_result_tile
import 'dart:async';
import 'package:flutter/material.dart';
import 'package:flutter_blue_plus/flutter_blue_plus.dart';

class UconScanResultTile extends StatefulWidget {
  UconScanResultTile({Key? key, required this.result, this.onTap}) : super(key: key);
  ...
  @override
  State<UconScanResultTile> createState() => _ScanResultTileState();
}

class _ScanResultTileState extends State<UconScanResultTile> {
