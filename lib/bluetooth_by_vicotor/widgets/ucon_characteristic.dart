...
class CharacteristicTile extends StatefulWidget {
  ...
  final Guid ucon = Guid('A40020C2-2DA0-9B61-B94F-4332828925BE');
  
  CharacteristicTile({Key? key, required this.characteristic, required this.descriptorTiles}) : super(key: key);
